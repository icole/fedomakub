...
cp ~/.local/share/fedomakub/configs/alacritty.toml ~/.config/alacritty/alacritty.toml
cp ~/.local/share/fedomakub/themes/tokyo-night/alacritty.toml ~/.config/alacritty/theme.toml
cp ~/.local/share/fedomakub/configs/alacritty/fonts/CaskaydiaMono.toml ~/.config/alacritty/font.toml
cp ~/.local/share/fedomakub/configs/alacritty/font-size.toml ~/.config/alacritty/font-size.toml
